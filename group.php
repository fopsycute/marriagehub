  ...
  <div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <div>
        ...
        <a href="<?php echo $siteurl; ?>all-group-blog/<?php echo $slug; ?>" class="btn btn-primary btn-sm me-2">
            <i class="bi bi-pencil-square"></i> Manage Blog
          </a> 
            <?php } ?>
        <?php if ($accessRole === 'creator' || $accessRole === 'admin' || $accessRole === 'member' || $accessRole === 'subadmin') { ?>
          ...
          <a href="<?php echo $siteurl; ?>my-group-blog/<?php echo $slug; ?>" class="btn btn-primary btn-sm me-2">
            <i class="bi bi-pencil-square"></i> my Blog
          </a>

        <?php } ?>
        <a href="<?php echo $siteurl; ?>group-blogs/<?php echo $slug; ?>" class="btn btn-outline-primary btn-sm">
          ...
          if (!empty($blogs)) {
              foreach ($blogs as $blog) {
                  if (
                      ...
                      $content = limitWords($blog->article, 4);
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <div>
        <?php if ($accessRole === 'creator' || $accessRole === 'admin' || $accessRole === 'subadmin' || $accessRole === 'member') { ?>
          <a href="<?php echo $siteurl; ?>create-group-question/<?php echo $group_slug; ?>" class="btn btn-primary btn-sm me-2">
            <i class="bi bi-pencil-square"></i> Create Q & A
          </a>

          <a href="<?php echo $siteurl; ?>all-group-question/<?php echo $slug; ?>" class="btn btn-primary btn-sm me-2">
            <i class="bi bi-pencil-square"></i> Manage Q & A
          </a> 
          
        <?php } ?>
        <a href="<?php echo $siteurl; ?>group-questions/<?php echo $group_slug; ?>" class="btn btn-outline-primary btn-sm">
          <i class="bi bi-grid"></i> View All
        </a>
      </div>
    </div>
    ...
    if ($data !== false) {
        ...
        if (!empty($questions)) {
          ...
          if (intval($question->group_id) != $group_id) continue;
                ...
                if ($count >= 20) break; // ✅ Limit to 20 per group

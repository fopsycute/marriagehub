...
//update questions
$(document).off('submit', '#editgroupQuestions').on('submit', '#editgroupQuestions', function(e) {
  e.preventDefault();
  ...
  var formData = new FormData(this);
  var siteUrl = $('#siteurl').val(); // hidden input for base URL
  formData.append('action', 'update_group_question');
  ...
  $.ajax({
    ...
    complete: function() {
      $submitBtn.prop('disabled', false).text('Submit Question');
      $('#editgroupQuestions').data('submitted', false);
    }
  });
});
...
$(document).off('submit', '#addgroupQuestions').on('submit', '#addgroupQuestions', function(e) {
  e.preventDefault();
  ...
  var formData = new FormData(this);
  var siteUrl = $('#siteurl').val(); // hidden input for base URL
  formData.append('action', 'creategroupQuestion');
  ...
  $.ajax({
    ...
    complete: function() {
      $submitBtn.prop('disabled', false).text('Submit Question');
      $('#addgroupQuestions').data('submitted', false);
    }
  });
});

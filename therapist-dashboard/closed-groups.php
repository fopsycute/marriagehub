 ...
 <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Tribes & Groups Request</h3>
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="#">Tribes & Groups Request</a>
                </li>
                <li class="separator">
                  <i class="icon-arrow-right"></i>
                </li>
            ...
            <div class="row">
                ...
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">Tribes & Groups Request</h4>
                  </div>
                  <div class="card-body">
...
if ($data !== false) {
    ...
    if (!empty($groups)) {
        foreach ($groups as $group) {
            ...
            if (isset($group->status) && $group->user_id == $buyerId && $group->status == "active" && $group->group_type == "closed") {
                $groupId = $group->id;
    ...
    <a href="view-request.php?group_id=<?php echo $groupId; ?>" 
       class="btn btn-link btn-primary btn-lg" 
       data-bs-toggle="tooltip" 
       title="View Requests">
        <i class="fa fa-eye"></i> View user requests (<?php echo $pendingCount; ?>)
    </a>
<?php endif; ?>

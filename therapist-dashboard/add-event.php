        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <textarea id="description" class="form-control" name="description" rows="4" placeholder="Enter event description"></textarea>
            </div>
            ...
            <div id="paidFields" style="display:none;">
              <div id="ticketsWrapper">
                <div class="ticketBox border p-3 mb-3">
                  ...
                  <input type="number" class="form-control" placeholder="Number of Seats Available" name="ticket_seats[]">
                </div>
              </div>

...
<div class="form-group" id="slotField" style="display:none;">
  ...
  <label for="productImages"><strong>Upload Product Images</strong></label>
    ...
    <small id="imageCountText" class="text-muted"></small>
        <small class="form-text text-muted">Free - 1, Classic - 5, Enterprise - 15, Premium - Unlimited</small>
      </div>
  ...
  <div class="form-group">
    ...
    <small id="videoCountText" class="text-muted"></small>


        <!-- Hidden inputs for limits -->
         <!-- Hidden limits (based on subscription plan) -->
      ...
      <input type="hidden" id="videoLimit" value="<?= htmlspecialchars(getFeatureLimit($con, $buyerId, 'videos', $siteprefix)) ?>">
        ...
        <small class="form-text text-muted">Max 3, 50MB each (Free - 1, Classic - 5, Enterprise - 15, Premium - Unlimited)</small>
      </div>
                 <div class="form-group">

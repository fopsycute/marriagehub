                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="multi-filter-select" class="display table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php
                                    $url = $siteurl . "script/admin.php?action=all_seller_product_reviews&seller_id=" . $buyerId;
                                    ...
                                    if ($data !== false) {
                                        ...
                                        if (!empty($reviews)) {
                                            foreach ($reviews as $review):
                                                ...
                                                $canRespond = canAccess($con, $buyerId, 'review_response', $siteprefix);
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <button class="btn btn-secondary btn-sm" disabled>Respond</button>
                                                <small class="text-muted d-block">Upgrade plan to reply</small>
                                            <?php endif; ?>
                                        </td>
                                    </tr>

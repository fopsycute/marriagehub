                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="filter-item search-form">
                            ...
                            <div class="input-group">
                                <input type="text" name="search" class="form-control" id="productSearch" placeholder="Search for products..." value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
                        ...
                        <div class="active-filters">
                            ...
                            <div class="filter-tags">
                                <?php if (!empty($_GET['search'])): ?>
                                    <span class="filter-tag"><?php echo htmlspecialchars($_GET['search']); ?> <button class="filter-remove" type="button" onclick="location.href='vendor-products.php?slug=<?php echo urlencode($vendorSlug); ?>' "><i class="bi bi-x"></i></button></span>
                                <?php endif; ?>
                                ...
                                <?php endif; ?>
                                <button class="clear-all-btn" type="button" onclick="location.href='vendor-products.php?slug=<?php echo urlencode($vendorSlug); ?>'">Clear All</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<section id="best-sellers" class="best-sellers section">
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        <div class="section-title" data-aos="fade-up">
            <h2><?php echo $vendorName; ?> &mdash; Products</h2>
            <p>Products offered by <?php echo $vendorName; ?></p>
        </div>
            ...
            if ($data !== false) {
                ...
                if (!empty($listings)) {
                    foreach ($listings as $listing) {
                        if (isset($listing->status) && strtolower($listing->status) === 'active' && (strtolower($listing->type) === 'product' || $listing->type === 'Product')) {

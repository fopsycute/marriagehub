                        ...
                        <div class="active-filters">
                            ...
                            <div class="filter-tags">
                                <?php if (!empty($_GET['search'])): ?>
                                    <span class="filter-tag"><?php echo htmlspecialchars($_GET['search']); ?> <button class="filter-remove" type="button" onclick="location.href='vendor-products/<?php echo urlencode($vendorSlug); ?>' "><i class="bi bi-x"></i></button></span>
                                <?php endif; ?>

 ...
 <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">All Disputes</h3>
            ...
            <div class="row">
                ...
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">All Disputes</h4>
                  </div>
                  <div class="card-body">
            ...
            $name = $first_name . ' ' . $last_name;
             ...
             $status = $dispute->status ?? '';
                ...
                <tr>
                    ...
                    <td><span class="badge bg-<?php echo getBadgeColor($status); ?>"><?php echo $status; ?></span></td>

 ...
 <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">All Vendor</h3>
...
if ($data !== false) {
    ...
    if (!empty($users)) {
        foreach ($users as $user) {
            ...
            if (isset($user->status) && $user->user_type == 'vendor' ) {
                $userId = $user->id;
                $email = $user->email;
                ...
                <tr>
                    ...
                    <td>
                        <a href='edit-vendor?vendor_id=<?php echo $userId; ?>' class='btn btn-link btn-primary btn-lg' data-bs-toggle='tooltip' title='Edit'>

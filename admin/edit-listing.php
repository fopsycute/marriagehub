...
<form method="POST" id="admineditlistingForm" enctype="multipart/form-data">
  ...
  <input type="hidden" name="action" value="editadmin_listing">
 ...
 <!-- EXISTING VIDEOS -->
  ...
  <div class="form-group">
    ...
    <select name="status" id="statusSelect" class="form-control">
      ...
      <option value="suspended" <?= ($status == 'suspended') ? 'selected' : ''; ?>>Reject</option>
    </select>
  </div>
  <div class="mb-3" id="suspendReasonBox" style="display: none;">
  <label class="form-label">Reason for Suspension</label>
  <textarea name="suspend_reason" class="editor" rows="3"><?= $suspendReason ?? '' ?></textarea>
</div>

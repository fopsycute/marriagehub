 ...
 <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">All Therapist</h3>
            ...
            <div class="row">
                ...
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">All Therapists</h4>
                  </div>
                  <div class="card-body">
...
if ($data !== false) {
    ...
    if (!empty($users)) {
        foreach ($users as $user) {
            ...
            if (isset($user->status) && $user->user_type == 'therapist' ) {
                $userId = $user->id;
                $email = $user->email;
                ...
                <tr>
                    ...
                    <td>
                        <a href='edit-therapist?therapist_id=<?php echo $userId; ?>' class='btn btn-link btn-primary btn-lg' data-bs-toggle='tooltip' title='Edit'>
